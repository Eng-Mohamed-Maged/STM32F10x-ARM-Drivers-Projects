...
u32 global_u32Data                      = 0 ;          /* Variables contains the recived Data              */
u32 global_u32DataInverted              = 0 ;          /* Variables contains the recived inverted Data     */
u32 global_u32Address                   = 0 ;          /* Variables contains the recived Address           */
u32 global_u32AddressInverted           = 0 ;          /* Variables contains the recived inverted Address  */
/****************************************************************************************************************/
